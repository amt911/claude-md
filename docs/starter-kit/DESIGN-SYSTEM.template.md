...
/* Semánticos */
--color-success: #______;  --color-warning: #______;
--color-error:   #______;  --color-info:    #______;
```
...
```css
--<dim>-<nivel1>:      #______;
--<dim>-<nivel1>-glow: rgba(_,_,_,0.20);
...
- **Shadows/glows:**
```css
--shadow-card: 0 2px 8px rgba(0,0,0,.5), 0 1px 2px rgba(0,0,0,.4);
